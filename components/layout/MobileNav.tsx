...
const menuItems = [
  ...
  { href: '/usuarios', label: 'Usuarios', icon: 'usersCog', ownerOnly: true },
...
const icons: Record<string, React.ReactNode> = {
  ...
  usersCog: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm6-3a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
  ),
};
